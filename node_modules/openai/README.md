...
const client = new OpenAI({
  apiKey: processREMOVED['OPENAI_API_KEY'], // This is the default and can be omitted
});
...
const client = new OpenAI({
  webhookSecret: processREMOVED.OPENAI_WEBHOOK_SECRET, // env var used by default; explicit here.
});
