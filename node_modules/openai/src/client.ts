...
export interface ClientOptions {
   ...
   * - Defaults to processREMOVED['OPENAI_API_KEY'].
  ...
  /**
   * Defaults to processREMOVED['OPENAI_ORG_ID'].
   */
  organization?: string | null | undefined;

  /**
   * Defaults to processREMOVED['OPENAI_PROJECT_ID'].
   */
  project?: string | null | undefined;

  /**
   * Defaults to processREMOVED['OPENAI_WEBHOOK_SECRET'].
   */
   ...
   *
   * Defaults to processREMOVED['OPENAI_BASE_URL'].
   */
   ...
   * Set the log level.
   *
   * Defaults to processREMOVED['OPENAI_LOG'] or 'warn' if it isn't set.
   */
...
export class OpenAI {
   ...
   * API Client for interfacing with the OpenAI API.
   *
   * @param {string | undefined} [opts.apiKey=processREMOVED['OPENAI_API_KEY'] ?? undefined]
   * @param {string | null | undefined} [opts.organization=processREMOVED['OPENAI_ORG_ID'] ?? null]
   * @param {string | null | undefined} [opts.project=processREMOVED['OPENAI_PROJECT_ID'] ?? null]
   * @param {string | null | undefined} [opts.webhookSecret=processREMOVED['OPENAI_WEBHOOK_SECRET'] ?? null]
   * @param {string} [opts.baseURL=processREMOVED['OPENAI_BASE_URL'] ?? https://api.openai.com/v1] - Override the default base URL for the API.
  ...
  constructor({
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('OPENAI_LOG'), "processREMOVED['OPENAI_LOG']", this) ??
      defaultLogLevel;
