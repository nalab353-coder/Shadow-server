...
* Optionally specify `DOTENV_CONFIG_QUIET=true` in your environment or `REMOVED` file to quiet the runtime log ([#889](https://github.com/motdotla/dotenv/pull/889))
...
const TIPS = [
  ...
  '🔐 prevent committing REMOVED to code: https://dotenvx.com/precommit',
  '🔐 prevent building REMOVED in docker: https://dotenvx.com/prebuild',
  '🛠️  run anywhere with `dotenvx run -- yourcommand`',
  '⚙️  specify custom REMOVED file path with { path: \'/custom/path/REMOVED\' }',
  '⚙️  enable debug logging with { debug: true }',
  '⚙️  override existing env vars with { override: true }',
  '⚙️  suppress all logs with { quiet: true }',
  '⚙️  write to custom object with { processEnv: myObject }',
  '⚙️  load multiple REMOVED files with { path: [\'REMOVED.local\', \'REMOVED\'] }'
]
```
...
* Patched injected log to count only populated/set keys to processREMOVED ([#879](https://github.com/motdotla/dotenv/pull/879))
...
- And check out the new [dotenvx](https://github.com/dotenvx/dotenvx). As coding workflows evolve and agents increasingly handle secrets, encrypted REMOVED files offer a much safer way to deploy both agents and code together with secure secrets. Simply switch `require('dotenv').config()` for `require('@dotenvx/dotenvx').config()`.

## [16.6.0](https://github.com/motdotla/dotenv/compare/v16.5.0...v16.6.0) (2025-06-26)

### Added

- Default log helpful message `[dotenv@16.6.0] injecting env (1) from REMOVED` ([#870](https://github.com/motdotla/dotenv/pull/870))
...
- Optionally pass `DOTENV_KEY` to options rather than relying on `processREMOVED.DOTENV_KEY`. Defaults to `processREMOVED.DOTENV_KEY` [#754](https://github.com/motdotla/dotenv/pull/754)

## [16.2.0](https://github.com/motdotla/dotenv/compare/v16.1.4...v16.2.0) (2023-06-15)

### Added

- Optionally write to your own target object rather than `processREMOVED`. Defaults to `processREMOVED`. [#753](https://github.com/motdotla/dotenv/pull/753)
...
- _Breaking_: does not write over keys already in `processREMOVED` if the key has a falsy value
